# Home - Zimbabwe LabTest IG v0.1.0
...
This is my first **Implementation Guide** example
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "LabTest",
  "title" : "Zimbabwe LabTest IG",
  "status" : "draft",
  "experimental" : false,
  "date" : "2025-11-12T08:22:09+00:00",
  "publisher" : "MoHCC Zimbabwe",
  "contact" : [
    {
      "name" : "MoHCC Zimbabwe",
      "telecom" : [
  ...
  "description" : "Laboratory SMART Guidelines Implementation Guides",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "name" : "Gender Allowed in Zimbabwe",
